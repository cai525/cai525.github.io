...
<div align="center"><img src="img/Cause-intervention/1694362308766.png" width=600></div>

从上图可以看出，”富有“这一变量直接影响”奢侈品“和”长寿“两个变量。在因果理论中，将这种变量称为混淆因子（confonder）。假设  $P(C=1 \vert X=1)=0.9$ ，$P(Y=1 \vert C=1)=0.9$，$P(Y=1 \vert C=0)=0.4$，$P(Y)$ 仅由  $C$决定 ，则：



$$\begin{align}
P(Y=1\vert X=1)&=\sum_{c}P(Y=1\vert X=1，C=c)P(C=c\vert X=1)\\
...
$$\begin{align}
P(Y=1\vert X=1)&=\sum_{c}P(Y=1\vert X=1，C=c)P(C=c)\\
...
<div align="center"><img src="img/Cause-intervention/1694433451087.png" width=700></div>
...
<div align="center"><img src="img/Cause-intervention/1694434810875.png" width=550></div>

<div align="center"><img src="img/Cause-intervention/1694435076475.png" width=800></div>
...
<div align="center"><img src="./img/Cause-intervention/1694435303486.png" width=600></div>
