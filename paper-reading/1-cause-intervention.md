...
从上图可以看出，”富有“这一变量直接影响”奢侈品“和”长寿“两个变量。在因果理论中，将这种变量称为混淆因子（confonder）。假设  

- $\begin{align}P(C=1|X=1)=0.9\end{align}$ 
- $\begin{align}P(Y=1|C=1)=0.9\end{align}$
- $\begin{align}P(Y=1|C=0)=0.4\end{align}$
